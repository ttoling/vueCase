<template>
  <div class="content">
    <p class="fhbtn">
      <!-- 使用原生的方法window.history.go(-1)返回上一个页面 -->
...
<style scoped>
  ...
  .content h1{width:2rem;height:2rem; background:url(../assets/img/user.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
