...
<style  scoped>
  ...
  .content h1{width:2rem;height:2rem; background:url(../assets/img/user1.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
